...
import { FormType, RentStatus } from 'src/app/utility/enums/enum';
...
export class OtpComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.rentCard = history.state.card;
  ...
  // confirmOtp(){
  //   this.router.navigateByUrl('/rent/rent-success');
  // }
  ...
  confirm() {
    let obj = {
      slipId: this.rentSlipObj.id,
      statusId: RentStatus.Paid
    };
    this.rentService.RentSlipStatusUpdate(obj).subscribe((res) => {
      //this.rentSlipObj = res;
      console.log('rentSlipStatusUpdate', res);
      this.router.navigateByUrl('/rent/rent-success',{state:{card:res}});
    }),
      (error) => {
