...
@Component({
  selector: 'app-mobile-recharge-payment-success',
  templateUrl: './mobile-recharge-payment-success.component.html',
  styleUrls: ['./mobile-recharge-payment-success.component.scss'],
})
export class MobileRechargePaymentSuccessComponent implements OnInit {
