...
import { PhoneADevice } from '../../@model/phoneADevice';
import { CardService } from '../../@service/card.service';

@Component({
  selector: 'app-mobile-recharge-otp',
  templateUrl: './mobile-recharge-otp.component.html',
  styleUrls: ['./mobile-recharge-otp.component.scss'],
})
export class MobileRechargeOtpComponent implements OnInit {
